...
const TodoRow = ({
  ...
  return (
    <div className="border-t-2 border-fernGreen-100-o33 flex justify-between items-center gap-3 w-full py-4">
      <div className="px-2 flex items-center gap-6 w-[calc(100%-26px)] h-12">
        ...
        <p
          className={classNames(
            'capitalize cursor-pointer w-[calc(100%-48px)] h-full overflow-hidden flex items-center text-darkJungleGreen-100-1 dark:text-cultured-100-1',
            {
